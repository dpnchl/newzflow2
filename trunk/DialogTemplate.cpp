...
static void _AfxConvertDialogUnitsToPixels(LPCTSTR pszFontFace, WORD wFontSize,
...
BOOL __cdecl CDialogTemplate::GetFont(const DLGTEMPLATE* pTemplate,
